...
public class Login extends JFrame {
	...
	public void loginComponent() {
		...
		Image userImage = userImageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		...
		Image showPassImage = showPassImageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		ImageIcon hidePassImageIcon = new ImageIcon(getClass().getResource("/resource/hidden.png"));
		Image hidePassImage = hidePassImageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		...
		Image userTypeImage = userTypeImageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		...
		gbl_bottom_panel.columnWidths = new int[]{155, 0, 0, 0};
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (usrSelect_combo.getSelectedItem() == "Student") {
						...
						if (state) new PopUpMessage("Logged In Successfully");
					...
					if (usrSelect_combo.getSelectedItem() == "Admin") {
						boolean state = new UserLogin().studentLogin(Integer.parseInt(uidString), pass);
		...
		register_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					new Create().addStudent(new Read().getID() + 1, fname, lname, date, address, gender, course, pass, email);
